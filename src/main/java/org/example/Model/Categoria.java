...
public class Categoria {
    ...
    @OneToMany(mappedBy = "idCategoria")
    private Set<org.example.Model.Recomendacion> recomendacions = new LinkedHashSet<>();
    ...
    public Set<org.example.Model.Recomendacion> getRecomendacions() {
        return recomendacions;
    }

    public void setRecomendacions(Set<org.example.Model.Recomendacion> recomendacions) {
